...
for (const simpson of simpsons) {
    ...
    div.innerText = `${simpson.name} ${simpson.surname} age ${simpson.age}`
...
simpsons.forEach(item => {
    ...
    for (let key in item) {
        if (key !== 'photo') {
            ...
            divSimpson.appendChild(divElement)
        } else {
...
for (const simpS of simpsons) {
    ...
    const divElement = document.createElement('div')
    divElement.classList = 'memberSS'
    const divName = document.createElement('div')
    divName.innerText = simpS.name
    const divSurname = document.createElement('div')
    divSurname.innerText = simpS.surname
    const divAge = document.createElement('div')
    divAge.innerText = simpS.age
    const divInfo = document.createElement('div')
    divInfo.innerText = simpS.info
    const img = document.createElement('img')
    img.src = simpS.photo
